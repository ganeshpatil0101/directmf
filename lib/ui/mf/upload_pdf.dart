...
class _UploadPdfState extends State<UploadPdf> {
    ...
    return Scaffold(
        ...
        body: Scrollbar(
            child: ListView(
              ...
              Padding(
                padding: const EdgeInsets.fromLTRB(28.0, 5.0, 28.0, 5.0),
                child: TextFormField(
  ...
  _chooseFile() async {
    String filePath;
    // Will filter and only let you pick files with pdf extension
    try {
  ...
  uploadFile() {
    MfApiService.upload_Pdf(this.file.path, passController.text).then((res) {
      print('success ----> $res');
    }).catchError((err) {
      print('error ---> $err');
    });
